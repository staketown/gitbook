...
```bash
bash <(curl -s https://raw.githubusercontent.com/staketown/cosmos/master/c4e/install.sh)
```
...
:up: Go to the state-sync section on [sync.md](sync.md "mention") page to quickly synchronise your node.
