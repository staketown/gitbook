...
```bash
bash <(curl -s https://raw.githubusercontent.com/staketown/cosmos/master/persistence/test_install.sh)
```
...
persistenceCore init "Your Moniker" --chain-id test-core-2
...
SEEDS=""
PEERS="166cd51d3d58c6c6329cdc6088217effd02c03e3@65.108.124.43:53656"
